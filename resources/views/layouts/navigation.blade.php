            ...
            {{-- MOBILE TOGGLE --}}
                <div class="sm:hidden flex items-center">
                    <button @click="open = !open"
                        ...
                        <svg :class="{ 'hidden': open, 'block': !open }" 
                            class="block w-5 h-5 transition-transform duration-300 group-hover:rotate-180" 
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h16M4 12h16M4 18h16" />
                        </svg>
                        <svg :class="{ 'hidden': !open, 'block': open }" 
                            class="hidden w-5 h-5 transition-transform duration-300" 
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M6 18L18 6M6 6l12 12" />
                        </svg>
                        <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    </button>
                </div>
                ...
                <div x-show="open" class="fixed inset-0 flex z-50 sm:hidden">
                    ...
                    <div class="relative flex flex-col w-80 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl shadow-2xl border-r border-gray-200/20 dark:border-gray-700/20"
                        ...
                        <!-- Header Sidebar -->
                        <div class="relative flex items-center justify-between h-20 px-6 border-b border-gray-200/30 dark:border-gray-700/30">
                        ...
                        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
                            @auth
                                <a href="{{ route('dashboard') }}"
                                    ...
                                    <div class="absolute left-0 w-1 h-8 bg-gradient-to-b from-blue-500 to-purple-500 rounded-r opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                            ...
                            <!-- Divider -->
                            <div class="my-6 h-px bg-gradient-to-r from-transparent via-gray-200 dark:via-gray-700 to-transparent"></div>
                            ...
                            <div class="space-y-2">
                                @auth
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <button type="submit"
                                            ...
                                            <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-red-500/5 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                            <div class="absolute left-0 w-1 h-8 bg-gradient-to-b from-red-500 to-pink-500 rounded-r opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                            <svg class="w-5 h-5 mr-3 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                @else
                                    <a href="{{ route('login') }}"
                                        ...
                                        <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-green-500/5 to-emerald-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                        <div class="absolute left-0 w-1 h-8 bg-gradient-to-b from-green-500 to-emerald-500 rounded-r opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                        <svg class="w-5 h-5 mr-3 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"
                                            ...
                                            <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500/5 to-pink-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                            <div class="absolute left-0 w-1 h-8 bg-gradient-to-b from-purple-500 to-pink-500 rounded-r opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                            <svg class="w-5 h-5 mr-3 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-4 border-t border-gray-200/30 dark:border-gray-700/30">
                            <div class="text-center">
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    Design with <span class="text-red-500">❤</span> by <a href="https://instagram.com/cainderev" class="text-md text-blue-50 hover:text-blue-300"> caidenrev</a>
                                </p>
                            </div>
                        </div>
                    </div>
